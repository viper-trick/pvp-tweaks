	...
	public static void bootstrap(Registerable<Enchantment> registry) {
		...
		register(
			...
			Enchantment.builder(
				...
				.addEffect(
					EnchantmentEffectComponentTypes.TICK,
					new PlaySoundEnchantmentEffect(List.of(SoundEvents.PARTICLE_SOUL_ESCAPE), ConstantFloatProvider.create(0.6F), UniformFloatProvider.create(0.6F, 1.0F)),
					AllOfLootCondition.builder(RandomChanceLootCondition.builder(0.35F), EntityPropertiesLootCondition.builder(LootContext.EntityReference.THIS, builder))
				)
		);
		register(
			registry,
		...
		register(
			...
			Enchantment.builder(
				...
				.addEffect(
					...
					EntityPropertiesLootCondition.builder(
						LootContext.EntityReference.ATTACKER, EntityPredicate.Builder.create().type(EntityTypePredicate.create(registryEntryLookup5, EntityType.PLAYER))
					)
				)
		);
		register(
			...
			Enchantment.builder(
				...
				.addEffect(
					...
					AllOfEnchantmentEffects.allOf(
						...
						new PlaySoundEnchantmentEffect(List.of(SoundEvents.ITEM_TRIDENT_THUNDER), ConstantFloatProvider.create(5.0F), ConstantFloatProvider.create(1.0F))
					),
					AllOfLootCondition.builder(
				...
				.addEffect(
					...
					AllOfLootCondition.builder(
						WeatherCheckLootCondition.create().thundering(true),
						EntityPropertiesLootCondition.builder(LootContext.EntityReference.THIS, EntityPredicate.Builder.create().type(registryEntryLookup5, EntityType.TRIDENT)),
