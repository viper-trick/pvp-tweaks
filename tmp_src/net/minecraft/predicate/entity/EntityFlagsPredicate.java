...
public record EntityFlagsPredicate(
	...
	public boolean test(Entity entity) {
		if (this.isOnGround.isPresent() && entity.isOnGround() != (Boolean)this.isOnGround.get()) {
			...
			if (this.isInWater.isPresent() && entity.isTouchingWater() != (Boolean)this.isInWater.get()) {
				return false;
			} else {
				return this.isFallFlying.isPresent() && entity instanceof LivingEntity livingEntity2x && livingEntity2x.isGliding() != this.isFallFlying.get()
					? false
					: !(this.isBaby.isPresent() && entity instanceof LivingEntity livingEntity2) || livingEntity2.isBaby() == (Boolean)this.isBaby.get();
			}
		}
	}
