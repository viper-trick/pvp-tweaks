...
public class JungleTempleGenerator extends ShiftableStructurePiece {
	...
	public void generate(
		...
		if (this.adjustToAverageHeight(world, chunkBox, 0)) {
			...
			this.addBlock(
				world, Blocks.TRIPWIRE_HOOK.getDefaultState().with(TripwireHookBlock.FACING, Direction.EAST).with(TripwireHookBlock.ATTACHED, true), 1, -3, 8, chunkBox
			);
			this.addBlock(
				world, Blocks.TRIPWIRE_HOOK.getDefaultState().with(TripwireHookBlock.FACING, Direction.WEST).with(TripwireHookBlock.ATTACHED, true), 4, -3, 8, chunkBox
			);
			this.addBlock(
				world,
			...
			this.addBlock(
				world, Blocks.TRIPWIRE_HOOK.getDefaultState().with(TripwireHookBlock.FACING, Direction.NORTH).with(TripwireHookBlock.ATTACHED, true), 7, -3, 1, chunkBox
			);
			this.addBlock(
				world, Blocks.TRIPWIRE_HOOK.getDefaultState().with(TripwireHookBlock.FACING, Direction.SOUTH).with(TripwireHookBlock.ATTACHED, true), 7, -3, 5, chunkBox
			);
			this.addBlock(
				world,
