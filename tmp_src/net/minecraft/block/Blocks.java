...
public class Blocks {
	...
	public static final Block COPPER_WALL_TORCH = register(
		...
		copyLootTable(COPPER_TORCH, true).noCollision().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block WAXED_COPPER_CHEST = register(
		"waxed_copper_chest",
		settings -> new CopperChestBlock(Oxidizable.OxidationLevel.UNAFFECTED, SoundEvents.BLOCK_COPPER_CHEST_OPEN, SoundEvents.BLOCK_COPPER_CHEST_CLOSE, settings),
