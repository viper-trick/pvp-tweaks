...
public class BrushableBlockEntity extends BlockEntity {
	...
	private boolean readLootTableFromData(ReadView view) {
		this.lootTable = (RegistryKey<LootTable>)view.read("LootTable", LootTable.TABLE_KEY).orElse(null);
	...
	protected void readData(ReadView view) {
		...
		this.hitDirection = (Direction)view.read("hit_direction", Direction.INDEX_CODEC).orElse(null);
	}
