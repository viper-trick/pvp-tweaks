...
public class SensorType<U extends Sensor<?>> {
	...
	public static final SensorType<NearestVisibleAdultSensor> NEAREST_ADULT_ANY_TYPE = register("nearest_adult_any_type", NearestFollowableFriendlyMobSensor::new);
