...
public class FuzzyTargeting {
	...
	@Nullable
	public static Vec3d findFrom(PathAwareEntity entity, double minHorizontalRange, double maxHorizontalRange, int verticalRange, Vec3d start) {
	...
	@Nullable
	private static Vec3d findValid(
	 ...
	 */
	@Nullable
	public static BlockPos towardTarget(PathAwareEntity entity, double horizontalRange, boolean posTargetInRange, BlockPos relativeInRangePos) {
