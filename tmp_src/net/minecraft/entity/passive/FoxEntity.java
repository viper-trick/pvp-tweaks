...
public class FoxEntity extends AnimalEntity {
	...
	protected void readCustomData(ReadView view) {
		...
		this.setVariant((FoxEntity.Variant)view.read("Type", FoxEntity.Variant.CODEC).orElse(FoxEntity.Variant.DEFAULT));
	...
	public void tick() {
		...
		if (this.canActVoluntarily()) {
			...
			if (this.isWalking() && this.getEntityWorld().random.nextFloat() < 0.2F) {
				...
				this.getEntityWorld().syncWorldEvent(WorldEvents.BLOCK_BROKEN, blockPos, Block.getRawIdFromState(blockState));
			}
		}
	...
	public class EatBerriesGoal extends MoveToTargetPosGoal {
		...
		private void pickSweetBerries(BlockState state) {
			...
			FoxEntity.this.getEntityWorld().setBlockState(this.targetPos, state.with(SweetBerryBushBlock.AGE, 1), Block.NOTIFY_LISTENERS);
