...
public class TradeOffers {
	...
	public interface Factory {
		 ...
		 */
		@Nullable
		TradeOffer create(ServerWorld world, Entity entity, Random random);
	}
	...
	public static class SellPotionHoldingItemFactory implements TradeOffers.Factory {
		...
		public TradeOffer create(ServerWorld world, Entity entity, Random random) {
			...
			List<RegistryEntry<Potion>> list = (List<RegistryEntry<Potion>>)Registries.POTION
				.streamEntries()
				.filter(entry -> !((Potion)entry.value()).getEffects().isEmpty() && world.getBrewingRecipeRegistry().isBrewable(entry))
