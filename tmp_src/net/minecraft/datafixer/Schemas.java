...
public class Schemas {
	...
	private static void build(DataFixerBuilder builder) {
		...
		builder.addFixer(new RenameEntityNbtKeyFix(schema167, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
		...
		builder.addFixer(
			RenameBlockEntityFix.create(schema184, "Rename Suspicious Sand to Brushable Block", replacing("minecraft:suspicious_sand", "minecraft:brushable_block"))
		);
		...
		builder.addFixer(
			new RenameEntityAttributesFix(schema214, "Rename jump strength attribute", replacing("minecraft:horse.jump_strength", "minecraft:generic.jump_strength"))
		);
		...
		builder.addFixer(
			new EntityAttributeBaseFix(
				schema247, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange
			)
		);
		builder.addFixer(
			new EntityAttributeBaseFix(
		...
		builder.addFixer(
			new EntityAttributeBaseFix(
				schema247, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", followRange -> followRange == 16.0 ? 12.0 : followRange
			)
		);
		builder.addFixer(
			new EntityAttributeBaseFix(
		...
		builder.addFixer(
			new SimpleBlockPropertyRenameFix(
				schema252, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", value -> value.equals("true") ? "awake" : "uprooted"
			)
		);
		...
		builder.addFixer(
			new AdvancementRenameFix(schema265, false, "Use lodestone category change", replacing("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone"))
		);
