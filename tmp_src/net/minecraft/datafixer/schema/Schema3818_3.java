...
public class Schema3818_3 extends IdentifierNormalizingSchema {
	...
	public static SequencedMap<String, Supplier<TypeTemplate>> method_63573(Schema schema) {
		...
		sequencedMap.put("minecraft:custom_name", (Supplier)() -> TypeReferences.TEXT_COMPONENT.in(schema));
		sequencedMap.put("minecraft:item_name", (Supplier)() -> TypeReferences.TEXT_COMPONENT.in(schema));
		sequencedMap.put("minecraft:lore", (Supplier)() -> DSL.list(TypeReferences.TEXT_COMPONENT.in(schema)));
		sequencedMap.put(
