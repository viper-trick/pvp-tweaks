...
public class TreeConfiguredFeatures {
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		ConfiguredFeatures.register(
			featureRegisterable, OAK_LEAF_LITTER, Feature.TREE, oak().decorators(ImmutableList.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
		);
		ConfiguredFeatures.register(
			featureRegisterable,
		...
		ConfiguredFeatures.register(
			featureRegisterable, BIRCH_LEAF_LITTER, Feature.TREE, birch().decorators(ImmutableList.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
		);
		ConfiguredFeatures.register(
			featureRegisterable, FANCY_OAK_LEAF_LITTER, Feature.TREE, fancyOak().decorators(List.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
		);
