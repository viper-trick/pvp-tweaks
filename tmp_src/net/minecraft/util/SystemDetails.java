...
public class SystemDetails {
	...
	public SystemDetails() {
		...
		this.addSection("JVM Flags", (Supplier<String>)(() -> collectJvmArguments(flag -> flag.startsWith("-X"))));
		this.addSection("Debug Flags", (Supplier<String>)(() -> collectJvmArguments(flag -> flag.startsWith("-DMC_DEBUG_"))));
	}
