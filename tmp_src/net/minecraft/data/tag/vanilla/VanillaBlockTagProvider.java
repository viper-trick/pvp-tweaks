...
public class VanillaBlockTagProvider extends ValueLookupTagProvider<Block> {
	...
	protected void configure(RegistryWrapper.WrapperLookup registries) {
		...
		this.builder(BlockTags.NEEDS_DIAMOND_TOOL).add(Blocks.OBSIDIAN, Blocks.CRYING_OBSIDIAN, Blocks.NETHERITE_BLOCK, Blocks.RESPAWN_ANCHOR, Blocks.ANCIENT_DEBRIS);
		...
		this.builder(BlockTags.INCORRECT_FOR_WOODEN_TOOL).addTag(BlockTags.NEEDS_DIAMOND_TOOL).addTag(BlockTags.NEEDS_IRON_TOOL).addTag(BlockTags.NEEDS_STONE_TOOL);
		...
		this.builder(BlockTags.REPLACEABLE)
			.add(registries.getOrThrow(RegistryKeys.BLOCK).streamEntries().map(RegistryEntry.Reference::value).filter(block -> block.getDefaultState().isReplaceable()));
