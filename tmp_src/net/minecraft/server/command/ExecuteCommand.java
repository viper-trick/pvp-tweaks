...
public class ExecuteCommand {
	...
	public static void register(CommandDispatcher<ServerCommandSource> dispatcher, CommandRegistryAccess commandRegistryAccess) {
		LiteralCommandNode<ServerCommandSource> literalCommandNode = dispatcher.register(
			CommandManager.literal("execute").requires(CommandManager.requirePermissionLevel(CommandManager.GAMEMASTERS_CHECK))
		);
		dispatcher.register(
							...
							CommandManager.argument("targets", EntityArgumentType.entities())
								.fork(
									...
									context -> {
										...
										for (Entity entity : EntityArgumentType.getOptionalEntities(context, "targets")) {
											list.add(
												context.getSource().withWorld((ServerWorld)entity.getEntityWorld()).withPosition(entity.getEntityPos()).withRotation(entity.getRotationClient())
											);
										}
				...
				.then(
					CommandManager.literal("positioned")
						...
						.then(CommandManager.literal("as").then(CommandManager.argument("targets", EntityArgumentType.entities()).fork(literalCommandNode, context -> {
							...
							for (Entity entity : EntityArgumentType.getOptionalEntities(context, "targets")) {
								list.add(context.getSource().withPosition(entity.getEntityPos()));
							}
				...
				CommandManager.literal("loaded")
					.then(
						addConditionLogic(
							...
							CommandManager.argument("pos", BlockPosArgumentType.blockPos()),
							positive,
							context -> isLoaded(context.getSource().getWorld(), BlockPosArgumentType.getBlockPos(context, "pos"))
						)
					)
			)
			.then(
	...
	private static boolean testStopwatchRange(CommandContext<ServerCommandSource> context, NumberRange.DoubleRange range) throws CommandSyntaxException {
		...
		StopwatchPersistentState stopwatchPersistentState = context.getSource().getServer().getStopwatchPersistentState();
