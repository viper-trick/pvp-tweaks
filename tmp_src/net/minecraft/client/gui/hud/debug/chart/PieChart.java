...
public class PieChart {
	...
	public void render(DrawContext context) {
		if (this.profileResult != null) {
			...
			int q = -1;
			int r = p - 62;
			context.drawTextWithShadow(this.textRenderer, string2, j, r, Colors.WHITE);
			string2 = decimalFormat.format(profilerTiming.totalUsagePercentage) + "%";
			context.drawTextWithShadow(this.textRenderer, string2, k - this.textRenderer.getWidth(string2), r, Colors.WHITE);
