...
public class CreateWorldScreen extends Screen {
	...
	public static void show(MinecraftClient client, Runnable runnable) {
		show(
			client, runnable, (screen, combinedDynamicRegistries, levelProperties, dataPackTempDir) -> screen.startServer(combinedDynamicRegistries, levelProperties)
		);
	}
	...
	private static void show(
		...
		client.setScreen(
			new CreateWorldScreen(client, runnable, (GeneratorOptionsHolder)completableFuture.join(), Optional.of(presetKey), OptionalLong.empty(), callback)
		);
	}
