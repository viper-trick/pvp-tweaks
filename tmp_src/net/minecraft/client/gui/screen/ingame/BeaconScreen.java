...
public class BeaconScreen extends HandledScreen<BeaconScreenHandler> {
	...
	protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
		context.drawCenteredTextWithShadow(this.textRenderer, PRIMARY_POWER_TEXT, 62, 10, Colors.LIGHTER_GRAY);
		context.drawCenteredTextWithShadow(this.textRenderer, SECONDARY_POWER_TEXT, 169, 10, Colors.LIGHTER_GRAY);
	}
