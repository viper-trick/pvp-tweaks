...
public class LlamaEntityModel extends EntityModel<LlamaEntityRenderState> {
	...
	private static ModelData transformBaby(ModelData modelData) {
		...
		float g = 0.7F;
		float h = 1.1F;
		UnaryOperator<ModelTransform> unaryOperator = modelTransform -> modelTransform.moveOrigin(0.0F, 21.0F, 3.52F).scaled(0.71428573F, 0.64935064F, 0.7936508F);
		...
		UnaryOperator<ModelTransform> unaryOperator3 = modelTransform -> modelTransform.moveOrigin(0.0F, 33.0F, 0.0F).scaled(0.45454544F, 0.41322312F, 0.45454544F);
