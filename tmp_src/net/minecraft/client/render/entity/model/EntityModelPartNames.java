...
public class EntityModelPartNames {
	...
	/**
	 * The key of an upper mouth model part, whose value is {@value}.
	 */
	public static final String UPPER_MOUTH = "upper_mouth";
	/**
	 * The key of an inner mouth model part, whose value is {@value}.
	 */
	public static final String INNER_MOUTH = "inner_mouth";
	/**
	 * The key of a lower mouth model part, whose value is {@value}.
	 */
	...
	/**
	 * The key of an inner body model part, whose value is {@value}.
	 */
	...
	/**
	 * The key of a goggles model part, whose value is {@value}.
	 */
	...
	/**
	 * The key of a harness model part, whose value is {@value}.
	 */
	public static final String HARNESS = "harness";
	/**
	 * The key of a shell model part, whose value is {@value}.
	 */
	...
	/**
	 * The key of a yellow coral model part, whose value is {@value}.
	 */
	public static final String YELLOW_CORAL = "yellow_coral";
	/**
	 * The key of a first yellow coral model part, whose value is {@value}.
	 */
	public static final String YELLOW_CORAL_FIRST = "yellow_coral_first";
	/**
	 * The key of a second yellow coral model part, whose value is {@value}.
	 */
	public static final String YELLOW_CORAL_SECOND = "yellow_coral_second";
	/**
	 * The key of a pink coral model part, whose value is {@value}.
	 */
	public static final String PINK_CORAL = "pink_coral";
	/**
	 * The key of a second pink coral model part, whose value is {@value}.
	 */
	public static final String PINK_CORAL_SECOND = "pink_coral_second";
	/**
	 * The key of a blue coral model part, whose value is {@value}.
	 */
	public static final String BLUE_CORAL = "blue_coral";
	/**
	 * The key of a first blue coral model part, whose value is {@value}.
	 */
	public static final String BLUE_CORAL_FIRST = "blue_first";
	/**
	 * The key of a second blue coral model part, whose value is {@value}.
	 */
	public static final String BLUE_CORAL_SECOND = "blue_second";
	/**
	 * The key of a red coral model part, whose value is {@value}.
	 */
	public static final String RED_CORAL = "red_coral";
	/**
	 * The key of a first red coral model part, whose value is {@value}.
	 */
	public static final String RED_CORAL_FIRST = "red_coral_first";
	/**
	 * The key of a second red coral model part, whose value is {@value}.
	 */
	public static final String RED_CORAL_SECOND = "red_coral_second";

	/**
	 * @return The key of a tentacle model part, suffixed with {@code index}.
	 */
