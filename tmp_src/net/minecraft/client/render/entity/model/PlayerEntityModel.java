...
public class PlayerEntityModel extends BipedEntityModel<PlayerEntityRenderState> {
	...
	public static EquipmentModelData<ModelData> createEquipmentModelData(Dilation hatDilation, Dilation armorDilation) {
		return BipedEntityModel.createEquipmentModelData(hatDilation, armorDilation).map(modelData -> {
			ModelPartData modelPartData = modelData.getRoot();
			ModelPartData modelPartData2 = modelPartData.getChild(EntityModelPartNames.LEFT_ARM);
			ModelPartData modelPartData3 = modelPartData.getChild(EntityModelPartNames.RIGHT_ARM);
			...
			ModelPartData modelPartData4 = modelPartData.getChild(EntityModelPartNames.LEFT_LEG);
			ModelPartData modelPartData5 = modelPartData.getChild(EntityModelPartNames.RIGHT_LEG);
			...
			ModelPartData modelPartData6 = modelPartData.getChild(EntityModelPartNames.BODY);
			modelPartData6.addChild(EntityModelPartNames.JACKET, ModelPartBuilder.create(), ModelTransform.NONE);
			return modelData;
		});
	}
