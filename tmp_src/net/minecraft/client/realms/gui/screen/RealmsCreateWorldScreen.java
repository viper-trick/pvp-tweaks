...
public class RealmsCreateWorldScreen extends RealmsScreen {
	...
	private static final Text CREATE_REALM_SUBTITLE = Text.translatable("mco.selectServer.create.subtitle").withColor(Colors.LIGHT_GRAY);
	private static final Text CREATE_WORLD_TITLE = Text.translatable("mco.configure.world.switch.slot");
	private static final Text CREATE_WORLD_SUBTITLE = Text.translatable("mco.configure.world.switch.slot.subtitle").withColor(Colors.LIGHT_GRAY);
	...
	private static final Text RESET_WORLD_SUBTITLE = Text.translatable("mco.reset.world.warning").withColor(Colors.RED);
