...
public class DurabilityScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new ModernButtonWidget(x, y, 180, 20,
            ...
            minecraft.setScreenAndShow(new DurabilityAdjusterScreen(this));
        })); y += 26;

        addRenderableWidget(new ModernButtonWidget(x, y, 180, 20,
            Component.literal("\ud83d\udd14 Alert Sound..."), () -> {
            minecraft.setScreenAndShow(new ModernSoundPickerScreen(this, cfg.soundDurabilityLow, "Durability Low", PvpTweaksConfig::save));
        })); y += 26;
