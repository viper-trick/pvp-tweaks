...
public final class CrosshairRenderer {
    ...
    public static void drawNative(GuiGraphicsExtractor ctx, int cx, int cy, PvpTweaksConfig cfg, float pixelScale) {
    ...
    private static void fillRectF(GuiGraphicsExtractor ctx, float x, float y, float w, float h, int color) {
