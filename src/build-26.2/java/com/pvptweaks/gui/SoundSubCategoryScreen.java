...
public class SoundSubCategoryScreen extends Screen {
    ...
    protected void init() {
        ...
        if (category.equals("Explosions")) {
            ...
            addRenderableWidget(new ModernButtonWidget(x, y, 110, 20, Component.literal("+ Add Sound"), () -> {
                minecraft.setScreenAndShow(new SoundSearchScreen(this));
            }));
        }
    ...
    private void addSoundRow(int x, int y, String label, com.pvptweaks.config.SoundProfile profile) {
        ...
        addRenderableWidget(new ModernButtonWidget(x + 145, y, 55, 20, Component.literal("Adv..."), () -> {
            this.minecraft.setScreenAndShow(new ModernSoundPickerScreen(this, profile, label, PvpTweaksConfig::save));
        }));
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        context.text(font, Component.literal("\u00a7l" + category.toUpperCase() + " SOUNDS"), width / 2, 25, UiPalette.ACCENT_BLUE);
        context.text(font, Component.literal("Customize pitch and advanced sound overrides"), width / 2, 38, UiPalette.TEXT_SECONDARY);
