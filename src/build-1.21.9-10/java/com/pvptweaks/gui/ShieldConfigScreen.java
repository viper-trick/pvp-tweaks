...
public class ShieldConfigScreen extends Screen {
    ...
    public ShieldConfigScreen(Screen parent) {
        super(Component.literal("Shield Adjuster"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        addRenderableWidget(new ModernButtonWidget(this.width - PANEL_W + 75, height - 35, 60, 20, Component.literal("Profile"), () -> {
        ...
        addRenderableWidget(new ModernButtonWidget(this.width - PANEL_W + 140, height - 35, 60, 20, Component.literal("Done"), () -> {
    ...
    public void render(GuiGraphics ctx, int mx, int my, float delta) {
        ...
        ctx.drawString(font, Component.literal("\u00a7lSHIELD ADJUSTER"), width - PANEL_W + 20, 15, UiPalette.ACCENT_BLUE);
        ctx.drawString(font, Component.literal("Live Preview Active"), width - PANEL_W + 20, 27, UiPalette.TEXT_SECONDARY);
