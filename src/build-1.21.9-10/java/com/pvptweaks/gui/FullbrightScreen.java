    ...
    private void openGammaUtilsSettings() {
        try {
            ...
            if (minecraft.player != null)
                minecraft.player.displayClientMessage(Component.literal("§c[PvP Tweaks] AutoConfig.getConfigScreen returned unexpected type: " + result.getClass().getName()), false);
        } catch (Exception e) {
            if (minecraft.player != null)
                minecraft.player.displayClientMessage(Component.literal("§c[PvP Tweaks] Error opening Gamma Utils settings: " + e.getClass().getSimpleName() + ": " + e.getMessage()), false);
            try {
                ...
                if (minecraft.player != null)
                    minecraft.player.displayClientMessage(Component.literal("§c[PvP Tweaks] Fallback also failed: " + e2.getClass().getSimpleName() + ": " + e2.getMessage()), false);
            }
        }
    }
