...
public class ExplosionSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new ModernButtonWidget(width / 2 - 50, height - 35, 100, 20, Component.literal("Done"), () -> minecraft.setScreen(parent)));
    }
    ...
    public void render(GuiGraphics ctx, int mx, int my, float delta) {
        ...
        ctx.drawCenteredString(font, Component.literal("\u00a7lDETAILED EXPLOSION SETTINGS"), width / 2, 25, UiPalette.ACCENT_BLUE);
