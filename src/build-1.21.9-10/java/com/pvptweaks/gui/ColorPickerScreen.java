...
public class ColorPickerScreen extends Screen {
    ...
    protected void init() {
        ...
        for (int i = 0; i < presetColors.length; i++) {
            ...
            addRenderableWidget(new ModernButtonWidget(px, py, buttonSize, buttonSize, Component.literal(""), () -> {
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        int cx = width / 2;
        context.drawCenteredString(font, Component.literal("\u00a7lColor Picker"), cx, height / 2 - 100, 0xFFFFFF);
        ...
        if (!errorMsg.isEmpty()) {
            context.drawCenteredString(font, Component.literal("\u00a7c" + errorMsg), cx, yField + 60, 0xFFFFFF);
        }
