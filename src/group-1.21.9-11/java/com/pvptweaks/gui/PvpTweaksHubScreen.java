    ...
    private void refreshCategoryWidgets() {
        ...
        if (activeCategory.name.equals("Home")) {
            ...
            addTooltipped(x2, y2, 160, 20, "\ud83d\udcc1 Profiles Folder",
                ...
                try { net.minecraft.util.Util.getPlatform().openFile(PvpTweaksProfiles.PROFILES_DIR.toFile()); } catch (Exception ignored) {}
            });
            ...
            addTooltipped(lx, ly, 300, 20, "\u00a79GitHub: \u00a77github.com/viper-trick/pvp-tweaks",
                ...
                try { net.minecraft.util.Util.getPlatform().openUri(new java.net.URI("https://github.com/viper-trick/pvp-tweaks")); } catch (Exception ignored) {}
            }); ly += 26;
            addTooltipped(lx, ly, 300, 20, "\u00a79Issues: \u00a77github.com/viper-trick/pvp-tweaks/issues",
                "Report bugs or request features", () -> {
                try { net.minecraft.util.Util.getPlatform().openUri(new java.net.URI("https://github.com/viper-trick/pvp-tweaks/issues")); } catch (Exception ignored) {}
            }); ly += 26;
            addTooltipped(lx, ly, 300, 20, "\u00a79Modrinth: \u00a77modrinth.com/mod/pvptweak",
                "View the mod on Modrinth", () -> {
                try { net.minecraft.util.Util.getPlatform().openUri(new java.net.URI("https://modrinth.com/mod/pvptweak")); } catch (Exception ignored) {}
            });
