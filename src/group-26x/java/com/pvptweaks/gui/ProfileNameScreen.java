...
public class ProfileNameScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new ModernButtonWidget(midX + 2, this.height / 2 + 16, 100, 20, Component.literal("Cancel"), () -> minecraft.setScreen(parent)));
    }
    ...
    public boolean keyPressed(KeyEvent input) {
        ...
        if (input.key() == GLFW.GLFW_KEY_ESCAPE) { minecraft.setScreen(parent); return true; }
