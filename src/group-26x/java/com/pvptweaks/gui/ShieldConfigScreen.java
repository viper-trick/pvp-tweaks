...
public class ShieldConfigScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor ctx, int mx, int my, float delta) {
        ...
        ctx.text(font, Component.literal("\u00a7lSHIELD ADJUSTER"), width - PANEL_W + 20, 15, UiPalette.ACCENT_BLUE);
        ctx.text(font, Component.literal("Live Preview Active"), width - PANEL_W + 20, 27, UiPalette.TEXT_SECONDARY);
